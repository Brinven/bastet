...
const sunnyDay = {
  ...
  document: {
    ...
    elements: [
      photo(64, 72, 952, 516, 46),
      tag(96, 540),
      name({ x: 64, y: 624, width: 820, fontSize: 96, fill: '#b3531a', fontFamily: 'Fredoka' }),
      fee({ x: 720, y: 648, width: 296 }),
      meta({ x: 66, y: 742, width: 948, fill: '#8a6d4a' }),
      bio({ x: 66, y: 796, width: 948, fill: '#5b4a39' }),
      badges({ x: 66, y: 892, width: 948 }),
...
const urgent = {
  ...
  document: {
    ...
    elements: [
      ...
      photo(64, 144, 952, 470, 22),
      tag(92, 566),
      name({ x: 64, y: 648, width: 700, fontSize: 96, fill: '#b3231a', fontFamily: 'Anton' }),
      fee({ x: 720, y: 664, width: 296 }),
      meta({ x: 66, y: 762, width: 948, fill: '#7a4a3f' }),
      bio({ x: 66, y: 814, width: 948, fontSize: 28, fill: '#5b3a32' }),
      badges({ x: 66, y: 900, width: 948 }),
...
const elegant = {
  ...
  document: {
    ...
    elements: [
      photo(72, 72, 936, 540, 12),
      name({ x: 72, y: 648, width: 700, fontSize: 86, fontWeight: 700, fill: '#2c2925', fontFamily: 'Playfair Display' }),
      fee({ x: 740, y: 664, width: 936 - 740 + 72 }),
      rect({ id: 'hairline', x: 74, y: 766, width: 132, height: 4, fill: '#bfa45e' }),
      meta({ x: 74, y: 792, width: 940, fontSize: 30, fill: '#6b6358' }),
      bio({ x: 74, y: 846, width: 940, fill: '#4d473e', lineHeight: 1.34 }),
      badges({ x: 74, y: 940, width: 940 }),
...
const spotlight = {
  ...
  document: {
    ...
    elements: [
      ...
      rect({
        id: 'scrim', x: 0, y: 520, width: 1080, height: 560,
        gradient: { stops: [0, 'rgba(20,14,10,0)', 0.5, 'rgba(20,14,10,0.72)', 1, 'rgba(20,14,10,0.94)'] },
      }),
      tag(72, 724),
      name({ x: 72, y: 806, width: 940, fontSize: 116, fontWeight: 400, fill: '#ffffff', fontFamily: 'Bebas Neue' }),
      meta({ x: 76, y: 946, width: 940, fontSize: 34, fill: '#f1e7d8' }),
