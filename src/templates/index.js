...
const name = (o) => ({
  ...
  placeholder: NAME_PH, fontWeight: 800, fill: 'role:ink', ...o,
})
const meta = (o) => ({
  id: 'meta', type: 'metaText', parts: META_PARTS, separator: '  ·  ',
  placeholder: META_PH, fontSize: 30, fill: 'role:inkSoft', ...o,
})
const bio = (o) => ({
  id: 'bio', type: 'text', fieldBinding: FIELDS.BIO, placeholder: BIO_PH,
  fontSize: 29, lineHeight: 1.32, fill: 'role:body', ...o,
})
...
const contact = (o) => ({
  ...
  band: 'role:bandBg', fill: 'role:onBand', ...o,
})
...
const sunnyDay = {
  ...
  moodTags: ['cheerful'],
  document: {
    outputSize: 'instagram_post', width: 1080, height: 1080, background: 'role:bg',
    elements: [
      photo(64, 72, 952, 476, 46),
      tag(96, 500),
      name({ x: 64, y: 584, width: 820, fontSize: 96, fill: 'role:accent', fontFamily: 'Fredoka' }),
      fee({ x: 720, y: 608, width: 296 }),
      meta({ x: 66, y: 702, width: 948 }),
      bio({ x: 66, y: 756, width: 948 }),
      custom({ x: 66, y: 846, width: 948 }),
      badges({ x: 66, y: 896, width: 948 }),
      contact({ x: 0, y: 988, width: 1080, height: 92 }),
    ],
  },
}
...
const urgent = {
  ...
  document: {
    ...
    elements: [
      ...
      tag(92, 532),
      name({ x: 64, y: 614, width: 700, fontSize: 96, fill: 'role:accent', fontFamily: 'Anton' }),
      fee({ x: 720, y: 630, width: 296 }),
      meta({ x: 66, y: 728, width: 948 }),
      bio({ x: 66, y: 780, width: 948, fontSize: 28 }),
      custom({ x: 66, y: 858, width: 948 }),
...
const elegant = {
  ...
  document: {
    ...
    elements: [
      ...
      name({ x: 72, y: 576, width: 700, fontSize: 86, fontWeight: 700, fill: 'role:ink', fontFamily: 'Playfair Display' }),
      fee({ x: 740, y: 592, width: 936 - 740 + 72 }),
      rect({ id: 'hairline', x: 74, y: 694, width: 132, height: 4, fill: 'role:accent' }),
      meta({ x: 74, y: 720, width: 940, fontSize: 30 }),
      bio({ x: 74, y: 774, width: 940, lineHeight: 1.34 }),
      custom({ x: 74, y: 864, width: 940 }),
      badges({ x: 74, y: 914, width: 940 }),
      contact({ x: 0, y: 992, width: 1080, height: 88 }),
    ],
  },
}
...
const boldStory = {
  ...
  moodTags: ['cheerful'],
  document: {
    outputSize: 'instagram_story', width: 1080, height: 1920, background: 'role:bg',
    elements: [
      photo(0, 0, 1080, 1200, 0),
      tag(60, 1104),
      name({ x: 72, y: 1244, width: 940, fontSize: 124, fill: 'role:accent', fontFamily: 'Fredoka' }),
      fee({ x: 700, y: 1276, width: 320 }),
      meta({ x: 74, y: 1392, width: 940, fontSize: 40 }),
      bio({ x: 74, y: 1456, width: 940, fontSize: 38 }),
      custom({ x: 74, y: 1572, width: 940 }),
      badges({ x: 74, y: 1626, width: 940 }),
      contact({ x: 0, y: 1804, width: 1080, height: 116 }),
    ],
  },
}
